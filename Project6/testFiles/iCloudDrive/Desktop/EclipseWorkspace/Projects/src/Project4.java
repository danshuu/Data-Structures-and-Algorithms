...
//		MorseCode m1 = new MorseCode('A', ".-");
//		System.out.println(MorseCode.get(0).getCode());
//		System.out.println(MorseCode.get(0).getCharacter());
//		System.out.println(m1.getCode());
//		System.out.println(m1.getCharacter());
//		Integer x = 5;
//		Integer y = 6;
//		System.out.println(x.compareTo(y));
//		System.out.println(x.compareTo(y));
...
//	public static class MadeUp {
//		Integer int1;
//		Integer int2;
//		public MadeUp(Integer int1, Integer int2) {
//			this.int1 = int1;
//			this.int2 = int2;
//		}
//		
//		
	 ...
	 */
	public static class MorseCode <T extends Comparable<? super T>>{
